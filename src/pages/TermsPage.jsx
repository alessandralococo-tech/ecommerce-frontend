  ...
  return (
    ...
    >
      ...
      <p style={{ textAlign: "center", maxWidth: "700px", margin: "0 auto", fontSize: "1rem", color: "#2d2d2d" }}>
        Qui puoi inserire tutti i termini e le condizioni d'uso del sito. Ad esempio regole sugli acquisti, resi e pagamenti sicuri.
      </p>

      <ul style={{ maxWidth: "600px", margin: "40px auto", padding: 0, listStyle: "none", display: "flex", flexDirection: "column", gap: "15px" }}>
        <li>⭐ Acquisti sicuri e garantiti</li>
        <li>⭐ Politica di reso semplice e chiara</li>
        <li>⭐ Protezione dei dati e privacy</li>
        <li>⭐ Supporto clienti disponibile sempre</li>
      </ul>
